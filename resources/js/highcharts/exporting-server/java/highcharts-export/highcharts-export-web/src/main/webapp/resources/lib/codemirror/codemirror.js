...
window.CodeMirror = (function () {
    ...
    function CodeMirror(place, givenOptions) {
        ...
        var instance = wrapper.CodeMirror = {
            ...
            getScrollInfo: function () {
                return {
                    x: scroller.scrollLeft, y: scrollbar.scrollTop,
        ...
        function onMouseDown(e) {
            ...
            if (options.dragDrop && dragAndDrop && !options.readOnly && !posEq(sel.from, sel.to) && !posLess(start, sel.from) && !posLess(sel.to, start) && type == "single") {
            ...
            for (var i = 0, l = changes.length || 0; i < l; ++i) {
                ...
                for (var j = 0, l2 = intact.length; j < l2; ++j) {
                    ...
                    if (change.to <= range.from && change.diff)
                        intact2.push({
                            from: range.from + diff, to: range.to + diff,
        ...
        function lineInfo(line) {
            ...
            var marker = line.gutterMarker;
            return {
                line: n, handle: line, text: line.text, markerText: marker && marker.text,
        ...
        function highlightWorker() {
            ...
            if (showingTo > startFrontier && frontier >= showingFrom)
                operation(function () {
                    changes.push({from: startFrontier, to: frontier});
                })();
        }
    ...
    function newHL(text, spans) {
        return spans ? {text: text, markedSpans: spans} : text;
    }
