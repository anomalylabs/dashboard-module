...
(function () {
    ...
    function W(a, b, c) {
        var d, e;
        if (Oa(b))t(c) ?
            a.setAttribute(b, c) : a && a.getAttribute && (e = a.getAttribute(b)); else if (t(b) && fa(b))for (d in b)a.setAttribute(d, b[d]);
        return e
    }
    ...
    function Mb() {
        var a =
            F.global.useUTC, b = a ? "getUTC" : "get", c = a ? "setUTC" : "set";
    ...
    var r, B = document, X = window, V = Math, s = V.round, S = V.floor, Va = V.ceil, w = V.max, z = V.min, M = V.abs, da = V.cos, ia = V.sin, ra = V.PI, Ma = ra * 2 / 360, Da = navigator.userAgent, Sb = X.opera, Ha = /msie/i.test(Da) && !Sb, lb = B.documentMode === 8, mb = /AppleWebKit/.test(Da),
        $a = /Firefox/.test(Da), cb = /(Mobile|Android|Windows Phone)/.test(Da), Ea = "http://www.w3.org/2000/svg", ca = !!B.createElementNS && !!B.createElementNS(Ea, "svg").createSVGRect, Yb = $a && parseInt(Da.split("Firefox/")[1], 10) < 4, ja = !ca && !Ha && !!B.createElement("canvas").getContext, Wa, ab, Tb = {}, Ab = 0, hb, F, ua, Ca, Bb, H, na = function () {
        }, aa = [], db = 0, Ta = "div", Y = "none", Zb = /^[0-9]+$/, $b = "stroke-width", ib, La, ub, vb, wb, Ua, jb, kb, Nb, Ob, xb, Pb, Qb, C = {}, P = X.Highcharts = X.Highcharts ? qa(16, !0) : {};
    ua = function (a, b, c) {
        if (!t(b) || isNaN(b))return "Invalid date";
        var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - La), e, f = d[vb](), g = d[wb](), h = d[Ua](), i = d[jb](), k = d[kb](), j = F.lang, l = j.weekdays, d = v({
            a: l[g].substr(0, 3),
            A: l[g],
            d: Qa(h),
            e: h,
    ...
    J && J.init.call(J, Bb);
    var nb = Q.adapterRun, ac = Q.getScript, wa = Q.inArray, q = Q.each, Cb = Q.grep, bc = Q.offset, xa = Q.map, A = Q.addEvent, R = Q.removeEvent, N = Q.fireEvent, cc = Q.washMouseEvent, ob = Q.animate, eb = Q.stop, Q = {
    ...
    Mb();
    var dc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, ec = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, fc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, Fa = function (a) {
        var b = [], c, d;
        (function (a) {
            a && a.stops ? d = xa(a.stops, function (a) {
                return Fa(a[1])
            }) : (c = dc.exec(a)) ? b = [I(c[1]), I(c[2]), I(c[3]), parseFloat(c[4],
                10)] : (c = ec.exec(a)) ? b = [I(c[1], 16), I(c[2], 16), I(c[3], 16), 1] : (c = fc.exec(a)) && (b = [I(c[1]), I(c[2]), I(c[3]), 1])
        })(a);
        return {
            get: function (c) {
                var f;
    ...
    Z.prototype = {
        init: function (a, b) {
            ...
            for (var c = this.shadows, d = c.length; d--;)c[d].setAttribute(a, a === "height" ? w(b - (c[d].cutHeight || 0), 0) : a === "d" ? this.d : b)
        }, addClass: function (a) {
            ...
            if (e) {
                ...
                if (Ha && !ca)E(this.element, a); else {
                    b = function (a, b) {
                        return "-" + b.toLowerCase()
                    };
                    for (f in a)g += f.replace(/([A-Z])/g, b) +
                    ":" + a[f] + ";";
                    W(d, "style", g)
                }
        ...
        invert: function () {
            ...
            return a && this.element.namespaceURI === Ea ? (this.element.removeAttribute("visibility"), this) : this.attr({visibility: a ? "inherit" : "visible"})
        },
        hide: function () {
            ...
            if (a) {
                ...
                for (e = 1; e <= i; e++) {
                    ...
                    h = i * 2 + 1 - 2 * e;
                    W(f, {
                        isShadow: "true", stroke: a.color || "black", "stroke-opacity": k * e, "stroke-width": h,
                        transform: "translate" + j, fill: Y
                    });
    ...
    ka.prototype = {
        ...
        destroy: function () {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(), f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = W(b, "x"), j = a.styles, l = a.textWidth,
                     m = j && j.lineHeight, n = g.length, p = function (a) {
                ...
                q(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            b.appendChild(u);
                            m++;
                            if (l)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), n = e.length > 1 && j.whiteSpace !== "nowrap", q, r, D = a._clipHeight, t = [], s = p(), w = 1; n && (e.length || t.length);)delete a.bBox, q = a.getBBox(), r = q.width, !ca && c.forExport && (r = c.measureSpanWidth(u.firstChild.data, a.styles)), q = r > l, !q || e.length === 1 ? (e = t, t = [], e.length && (w++,
                                D && w * s > D ? (e = ["..."], a.attr("title", a.textStr)) : (u = B.createElementNS(Ea, "tspan"), W(u, {
                                    dy: s,
                                    x: k
                                }), o && W(u, "style", o), b.appendChild(u), r > l && (l = r)))) : (u.removeChild(u.firstChild), t.unshift(e.pop())), e.length && u.appendChild(B.createTextNode(e.join(" ").replace(/- /g, "-")))
                        }
                    }
                })
            }))
        }, button: function (a, b, c, d, e, f, g, h, i) {
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, n, p, u, o, a = {
                x1: 0,
                y1: 0,
                x2: 0,
                y2: 1
            ...
            o = h.style;
            delete h.style;
            A(k.element, Ha ? "mouseover" : "mouseenter", function () {
                j !== 3 && k.attr(f).css(p)
            });
            A(k.element, Ha ? "mouseout" : "mouseleave", function () {
                j !== 3 && (l = [e, f, g][j], m = [n, p, u][j], k.attr(l).css(m))
            });
            k.setState = function (a) {
                (k.state = j = a) ? a === 2 ? k.attr(g).css(u) : a === 3 && k.attr(h).css(o) : k.attr(e).css(n)
            };
            ...
            }, k = a.match(i)[1], a = Tb[k], g = this.image(k).attr({
                x: b,
                y: c
            ...
            circle: function (a, b, c, d) {
                ...
                var f = e.start, c = e.r || c || d, g = e.end - 0.001,
                    d = e.innerR, h = e.open, i = da(f), k = ia(f), j = da(g), g = ia(g), e = e.end - f < ra ? 0 : 1;
            ...
            return v(n, {
                css: function (a) {
                    ...
                    return {width: o.width + 2 * x, height: o.height + 2 * x, x: o.x - x, y: o.y - x}
                }, shadow: function (a) {
                    u && u.shadow(a);
                    return n
                }, destroy: function () {
                ...
                if (this.parentGroup = a) {
                    if (b = a.div, !b) {
                        ...
                        q(k.reverse(), function (a) {
                            var d;
                            b = a.div = a.div || $(Ta, {className: W(a.element, "class")}, {
                                position: "absolute",
    ...
    if (!ca && !ja)P.VMLElement = ea = {
        init: function (a, b) {
            ...
            var b =
                this.renderer, c = this.element, d = b.box, d = a ? a.element || a : d;
        ...
        getSpanCorrection: function (a, b, c, d, e) {
            ...
            for (var b = a.length, c = []; b--;)if (la(a[b]))c[b] = s(a[b] * 10) - 5; else if (a[b] === "Z")c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at"))c[b + 5] ===
            ...
            var d = c.nodeName;
            if (d === "SPAN")c.style.color = a; else if (d !== "IMG")c.filled = a !== Y, this.setAttr("fillcolor", this.renderer.color(a, c, b, this))
        ...
        Element: ea, isIE8: Da.indexOf("MSIE 8.0") > -1, init: function (a, b, c, d) {
            var e;
            this.alignedObjects = [];
        ...
        clipRect: function (a, b, c, d) {
            ...
            if (i) {
                var j, l, m = a.linearGradient || a.radialGradient, n, p, u, o, G, x = "", a = a.stops, r, t = [], s = function () {
                ...
                if (c === "fill")if (i === "gradient")c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, n = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, x = 'angle="' + (90 - V.atan((m - a) / (n - c)) * 180 / ra) + '"', s(); else {
                    var k = m.r, w = k * 2, v = k * 2, y = m.cx, D = m.cy, U = b.radialReference, z, k = function () {
            ...
            } else if (g.test(a) && b.tagName !== "IMG")f = Fa(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], $(this.prepVML(h), null, null, b), k = f.get("rgb"); else {
            ...
            return a
        }, text: ka.prototype.html, path: function (a) {
            ...
            arc: function (a, b, c, d, e) {
                var f = e.start, g = e.end, h = e.r || c ||
                    d, c = e.innerR, d = da(f), i = ia(f), k = da(g), j = ia(g);
                if (g - f === 0)return ["x"];
    ...
    }, ea.prototype.symbols = {}, Vb = function () {
        function a() {
            var a = b.length, d;
            for (d = 0; d < a; d++)b[d]();
            b = []
    ...
    Za.prototype = {
        addLabel: function () {
            var a =
                this.axis, b = a.options, c = a.chart, d = a.horiz, e = a.categories, f = a.names, g = this.pos, h = b.labels, i = a.tickPositions, d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || c.chartWidth * 0.33), k = g === i[0], j = g === i[i.length - 1], l, f = e ? o(e[g], f[g], g) : g, e = this.label, m = i.info;
            a.isDatetimeAxis && m && (l = b.dateTimeLabelFormats[m.higherRanks[g] || m.unitName]);
            this.isFirst = k;
            this.isLast = j;
            b = a.labelFormatter.call({
                axis: a, chart: c, isFirst: k, isLast: j, dateTimeLabelFormat: l, value: a.isLog ? ha(oa(f)) :
                    f
            });
            ...
            var a = this.label.getBBox(), b = this.axis, c = b.horiz, d = b.options.labels,
                a = c ? a.width : a.height, b = c ? d.x - a * {left: 0, center: 0.5, right: 1}[b.labelAlign] : 0;
            return [b, c ? a + b : a]
            ...
            if (m) {
                ...
                do a += e ? 1 : -1, n = d.ticks[i[a]]; while (i[a] && (!n || n.label.line !== p));
                d = n &&
            ...
            var i =
                this.axis, k = i.transA, j = i.reversed, l = i.staggerLines, m = i.chart.renderer.fontMetrics(e.style.fontSize).b, n = e.rotation, a = a + e.x - (f && d ? f * k * (j ? -1 : 1) : 0), b = b + e.y - (f && !d ? f * k * (j ? 1 : -1) : 0);
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type,
                i = this.label, k = this.pos, j = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid", n = h ? h + "Tick" : "tick", p = e[m + "LineWidth"], u = e[m + "LineColor"], q = e[m + "LineDashStyle"], G = e[n + "Length"], m = e[n + "Width"] || 0, x = e[n + "Color"], t = e[n + "Position"], n = this.mark, s = j.step, w = !0, v = d.tickmarkOffset, y = this.getPosition(g, k, v, b), z = y.x, y = y.y, D = g && z === d.pos + d.len || !g && y === d.pos ? -1 : 1;
            this.isActive = !0;
            if (p) {
            ...
            if (m && G)t === "inside" && (G = -G), d.opposite && (G = -G), h = this.getMarkPath(z, y, G, m * D, g, f), n ? n.animate({
                d: h,
                opacity: c
            }) : this.mark = f.path(h).attr({stroke: x, "stroke-width": m, opacity: c}).add(d.axisGroup);
            if (i && !isNaN(z))i.xy = y = this.getLabelPosition(z, y, i, g, j, v, a, s), this.isFirst && !this.isLast && !o(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !o(e.showLastLabel, 1) ? w = !1 : !d.isRadial && !j.step && !j.rotation && !b &&
    ...
    P.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label, h = e.width, i = e.to, k = e.from, j = t(k) && t(i), l = e.value, m = e.dashStyle, n = a.svgElem, p = [], u, q = e.color, G = e.zIndex, x = e.events,
                r = {}, s = b.chart.renderer;
            ...
            if (t(G))r.zIndex = G;
            if (n)if (p)n.animate({d: p}, null, n.onGetPath); else {
                if (n.hide(), n.onGetPath = function () {
                        n.show()
                    }, g)a.label = g = g.destroy()
            } else if (p && p.length && (a.svgElem = n = s.path(p).attr(r).add(), x))for (u in d =
                function (b) {
                    n.on(b, function (c) {
                        x[b].apply(a, [c])
                    })
    ...
    L.prototype = {
        ...
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat, e = F.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format,
                a = a.isLog ? b : a.tickInterval;
            if (h)g = Ja(h, this); else if (c)g = b; else if (d)g = ua(d, b); else if (f && a >= 1E3)for (; f-- && g === r;)c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ia(b / c, -1) + e[f]);
        ...
        translate: function (a, b, c, d, e, f) {
            var g = 1, h = 0, i = d ? this.oldTransA : this.transA, d = d ? this.oldMin : this.min, k = this.minPixelPadding, e = (this.options.ordinal || this.isLog &&
                e) && this.lin2val;
            if (!i)i = this.transA;
            if (c)g *= -1, h = this.len;
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            var f = this.chart, g = this.left,
                h = this.top, i, k, j = c && f.oldChartHeight || f.chartHeight, l = c && f.oldChartWidth || f.chartWidth, m;
            i = this.transB;
        ...
        adjustForMinRange: function () {
            var a =
                this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h, i, k;
            if (this.isXAxis && this.minRange === r && !this.isLog)t(a.min) || t(a.max) ? this.minRange = null : (q(this.series, function (a) {
                i = a.xData;
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options,
                e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k, j = 0, l, m = 0, n = d.title, p = d.labels, u = 0, Db = b.axisOffset, G = b.clipOffset, x = [-1, 1, 1, -1][h], s, v = 1, y = o(p.maxStaggerLines, 5), z, A, B, D, U = h === 2 ? c.fontMetrics(p.style.fontSize).b : 0;
            a.hasData = k = a.hasVisibleSeries || t(a.min) && t(a.max) && !!e;
            a.showAxis = b = k || o(d.showEmpty, !0);
            a.staggerLines = a.horiz && p.staggerLines;
            if (!a.axisGroup)a.gridGroup = c.g("grid").attr({zIndex: d.gridZIndex || 1}).add(), a.axisGroup = c.g("axis").attr({zIndex: d.zIndex || 2}).add(),
            ...
            if (k || a.isLinked) {
                ...
                q(e, function (b) {
                    if (h === 0 || h === 2 || {1: "left", 3: "right"}[h] === a.labelAlign)u = w(f[b].getLabelSize(), u)
                });
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c, g = this.opposite, h = this.offset, i = I(e.style.fontSize || 12), d = {
                low: f + (a ? 0 : d),
                middle: f + d / 2,
                high: f + (a ? d : 0)
        ...
        render: function () {
            ...
            if (s || h)if (a.minorTickInterval && !a.categories &&
                q(a.getMinorTickPositions(), function (b) {
                    ...
                    if (c % 2 === 0 && b < a.max)n[b] || (n[b] = new P.PlotLineOrBand(a)),
                        v = b + o, A = i[c + 1] !== r ? i[c + 1] + o : a.max, n[b].options = {
                        from: g ? oa(v) : v,
                        to: g ? oa(A) : A,
                        color: u
            ...
            q([l, m, n], function (a) {
                var b, c, e = [], f = Ca ? Ca.duration || 500 : 0, g = function () {
            ...
            if (G)b = a.getLinePath(G), a.axisLine ? a.axisLine.animate({d: b}) : a.axisLine = e.path(b).attr({
                stroke: f.lineColor,
                "stroke-width": G,
                zIndex: 7
    ...
    L.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (t(b)) {
            ...
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Ua](), n = g ? La : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), k === H.year ? d = ib(h + b * j, 0) : k === H.month ? d = ib(h, l + b * j) : !g && (k === H.day || k === H.week) ? d = ib(h, l, m + b * j * (k === H.day ?
                1 : 7)) : d += k * j, b++;
            e.push(d);
            q(Cb(e, function (a) {
    ...
    L.prototype.normalizeTimeTickInterval = function (a, b) {
        ...
        for (g = 0; g < c.length; g++)if (d = c[g], e = H[d[0]], f = d[1], c[g +
    ...
    L.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5)a = s(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = S(b), h, i, k, j, l, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
            for (h = 0; h < i && !l; h++)k = Ga(oa(f) * e[h]), k > b && (!d ||
    ...
    Hb.prototype = {
        init: function (a, b) {
            ...
            var e =
                this, f = e.now, g = e.options.animation !== !1 && !e.isHidden, h = e.followPointer || e.len > 1;
            v(f, {
                x: g ? (2 * f.x + a) / 3 : a,
                y: g ? (f.y + b) / 2 : b,
            ...
            }), g /= a.length, h /= a.length, c = [e ? d.plotWidth - h : g, this.shared && !e && a.length > 1 && b ? b.chartY -
            f : e ? d.plotHeight - g : h]);
            return xa(c, s)
        }, getPosition: function (a, b, c) {
            var d = this.chart, e = this.distance, f = {}, g, h = ["y", d.chartHeight, b, c.plotY + d.plotTop], i = ["x", d.chartWidth, a, c.plotX + d.plotLeft], k = c.ttBelow || d.inverted && !c.negative || !d.inverted && c.negative, j = function (a, b, c, d) {
                var g = c < d - e, b = d + e + c < b, c = d - e - c;
                d += e;
                if (k && b)f[a] = d; else if (!k && g)f[a] = c; else if (g)f[a] = c; else if (b)f[a] = d; else return !1
            }, l = function (a, b, c, d) {
            ...
            i === !1 ? this.hide() : (this.isHidden && (eb(d), d.attr("opacity", 1).show()), d.attr({text: i}), j = e.borderColor || a.color || h.color || "#606060", d.attr({stroke: j}), this.updatePosition({
                plotX: f,
                plotY: g,
                negative: a.negative,
                ttBelow: a.ttBelow
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert,
                h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, l, m = this.mouseDownX, n = this.mouseDownY;
            d < h ? d = h : d > h + k && (d = h + k);
            e < i ? e = i : e > i + j && (e = i + j);
            ...
            if (this.selectionMarker) {
                ...
                }, a = this.selectionMarker, e = a.attr ? a.attr("x") : a.x, f = a.attr ? a.attr("y") : a.y, g = a.attr ? a.attr("width") : a.width, h = a.attr ? a.attr("height") : a.height, i;
                if (this.hasDragged || c)q(b.axes, function (a) {
                    if (a.zoomEnabled) {
                        var b =
                            a.horiz, c = a.toValue(b ? e : f), b = a.toValue(b ? e + g : f + h);
                        !isNaN(c) && !isNaN(b) && (d[a.coll].push({axis: a, min: z(c, b), max: w(c, b)}), i = !0)
                    }
                }), i && N(b, "selection", d, function (a) {
    ...
    v(P.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", l = "chart" + j, m = a ? "width" : "height", n = i["plot" + (a ? "Left" : "Top")], p, u, o = h || 1, q = i.inverted, x = i.bounds[a ? "h" : "v"], r = b.length === 1, s = b[0][l], t = c[0][l], w = !r && b[1][l], v = !r && c[1][l], y, c = function () {
                !r &&
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = b.followTouchMove, f = a.touches, g = f.length, h = b.lastValidTouch, i = b.hasZoom, k = b.selectionMarker, j = {}, l = g === 1 && (b.inClass(a.target, "highcharts-tracker") &&
                c.runTrackerClick || c.runChartClick), m = {};
    ...
    if (X.PointerEvent || X.MSPointerEvent) {
        var ya = {}, Ib = !!X.PointerEvent, gc = function () {
            var a, b = [];
            b.item = function (a) {
                return this[a]
            };
            ...
            a = a.originalEvent || a;
            if ((a.pointerType === "touch" || a.pointerType === a.MSPOINTER_TYPE_TOUCH) && aa[sa])d(a), d = aa[sa].pointer, d[b]({
                type: c,
            ...
            onContainerPointerDown: function (a) {
                Jb(a,
                    "onContainerTouchStart", "touchstart", function (a) {
                        ya[a.pointerId] = {pageX: a.pageX, pageY: a.pageY, target: a.currentTarget}
                    })
    ...
    pb.prototype = {
        init: function (a, b) {
            ...
            this.options = b;
            if (b.enabled)c.baseline = I(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = y(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.symbolWidth = o(b.symbolWidth, 16), c.pages = [], c.render(), A(c.chart, "endResize", function () {
        ...
        colorizeItem: function (a, b) {
            ...
            var b = this.chart,
                c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth, g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, k = this.padding, j = e ? o(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0, p = this.itemMarginTop, u = this.initialItemX, q = a.legendItem, G = a.series && a.series.drawLegendSymbol ? a.series : a, x = G.options, x = this.createCheckboxForItem && x && x.showCheckbox, r = d.useHTML;
            if (!q)a.legendGroup = c.g("legend-item").attr({zIndex: 1}).add(this.scrollGroup), G.drawLegendSymbol(this, a), a.legendItem =
                q = c.text(d.labelFormat ? Ja(d.labelFormat, a) : d.labelFormatter.call(a), l ? f + g : -g, this.baseline, r).css(y(a.visible ? h : i)).attr({
                    align: l ? "left" : "right",
                    zIndex: 2
                }).add(a.legendGroup), this.setItemEvents && this.setItemEvents(a, q, r, h, i), this.colorizeItem(a, a.visible), x && this.createCheckboxForItem(a);
            c = q.getBBox();
            f = a.checkboxOffset = d.itemWidth || a.legendItemWidth || f + g + c.width + j + (x ? 20 : 0);
            this.itemHeight = g = s(a.legendItemHeight || c.height);
            if (e && this.itemX - u + f > (m || b.chartWidth - 2 * k - u - d.x))this.itemX = u, this.itemY +=
            ...
            q(this.chart.series, function (b) {
                var c = b.options;
                if (o(c.showInLegend, !t(c.linkedTo) ? r : !1, !0))a = a.concat(b.legendItems || (c.legendType === "point" ? b.data :
                    b))
            });
            return a
        }, render: function () {
            ...
            if (a > f && !e.useHTML) {
                ...
                if (!m)this.nav = m = d.g().attr({zIndex: 1}).add(this.group), this.up = d.symbol("triangle", 0, 0, l, l).on("click", function () {
                    b.scroll(-1, j)
                }).add(m), this.pager = d.text("",
                    15, 10).css(k.style).add(m), this.down = d.symbol("triangle-down", 0, 0, l, l).on("click", function () {
                    b.scroll(1, j)
                }).add(m);
                b.scroll(0);
                a = f
    ...
    Q = P.LegendSymbolMixin = {
        drawRectangle: function (a, b) {
            ...
            if (c && c.enabled !== !1)b = c.radius, this.legendSymbol = d = e.symbol(this.symbol, d / 2 - b, a - b, 2 *
    ...
    va.prototype = {
        ...
        adjustTickAmounts: function () {
            ...
            var a = this, b = this.options, c = b.xAxis = ma(b.xAxis || {}), b = b.yAxis = ma(b.yAxis ||
            {});
            q(c, function (a, b) {
                a.index = b;
                a.isX = !0
            ...
            var b =
                0, c = this.title, d = this.subtitle, e = this.options, f = e.title, e = e.subtitle, g = this.spacingBox.width - 44;
        ...
        getChartSize: function () {
            ...
            a ? b && (this.renderTo.appendChild(c), Sa(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c),
                this.renderToClone = b = this.renderTo.cloneNode(0), E(b, {
                position: "absolute",
                top: "-9999px",
                display: "block"
            ...
            if (c.display && !e.floating)if (i === "right") {
                ...
                if (!t(d[3]))this.plotLeft = w(this.plotLeft,
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || nb(d, "width"), f = c.height || nb(d, "height"), c = a ? a.target : X, d = function () {
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight, e = this.chartBackground, f = this.plotBackground, g = this.plotBorder, h = this.plotBGImage, i = a.borderWidth || 0, k = a.backgroundColor, j = a.plotBackgroundColor, l = a.plotBackgroundImage, m = a.plotBorderWidth || 0, n, p = this.plotLeft, u = this.plotTop, o = this.plotWidth, q = this.plotHeight,
                x = this.plotBox, r = this.clipRect, s = this.clipBox;
            n = i + (a.shadow ? 8 : 0);
            ...
            if (f.enabled && !a.credits)g = f.href, a.credits = c.text(f.text,
    ...
    za.prototype = {
        init: function (a, b, c) {
            ...
            if (typeof a === "number" || a === null)b[d[0]] = a; else if (Pa(a)) {
                if (a.length >
                    e) {
                    c = typeof a[0];
    ...
    K.prototype = {
        ...
        getSymbol: function () {
            var a =
                this.userOptions, b = this.options.marker, c = this.chart, d = c.options.symbols, c = c.counters;
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, l = e.xAxis, m = l && !!l.categories, n = e.tooltipPoints, p = i.turboThreshold, u = this.xData, s = this.yData, G =
                (h = e.pointArrayMap) && h.length, a = a || [];
            h = a.length;
            b = o(b, !0);
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData)q(a, function (a, b) {
                ...
                if (p && h > p) {
                    ...
                    if (la(j)) {
                        ...
                        e.xIncrement = m
                    } else if (Pa(j))if (G)for (c = 0; c < h; c++)i = a[c], u[c] = i[0], s[c] = i.slice(1, G + 1); else for (c =
                                                                                                                                 0; c < h; c++)i = a[c], u[c] = i[0], s[c] = i[1]; else qa(12)
        ...
        processData: function (a) {
            ...
            var f, g, h = this.xAxis,
                i = this.options, k = i.cropThreshold, j = 0, l = this.isCartesian, m, n;
            if (l && !this.isDirty && !h.isDirty && !this.yAxis.isDirty && !a)return !1;
            if (l && this.sorted && (!k || d > k || this.forceCrop))if (m = h.min, n = h.max, b[d - 1] < m || b[0] > n)b = [], c = []; else if (b[0] < m || b[d - 1] > n)e = this.cropData(this.xData, this.yData, m, n), b = e.xData, c = e.yData, e = e.start, f = !0, j = b.length;
        ...
        generatePoints: function () {
            var a = this.options.data, b = this.data, c, d = this.processedXData, e = this.processedYData, f = this.pointClass, g = d.length, h = this.cropStart || 0, i, k = this.hasGroupedData,
                j, l = [], m;
        ...
        getExtremes: function (a) {
            ...
            d = a.length;
            for (l = 0; l < d; l++)if (k = c[l], j = a[l], i = j !== null && j !== r && (!b.isLog || j.length || j > 0), k = this.getExtremesFromAll || this.cropped || (c[l + 1] || k) >= g && (c[l - 1] || k) <= h, i && k)if (i = j.length)for (; i--;)j[i] !== null && (e[f++] = j[i]); else e[f++] = j;
        ...
        drawPoints: function () {
            ...
            if (d.enabled !== !1 || this._hasPointMarkers)for (f = b.length; f--;)if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, i = g.marker || {}, a = p && i.enabled === r || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== r && !isNaN(e) && g.y !== null)if (a =
                    g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = o(i.symbol, this.symbol), k = i.indexOf("url") === 0, j)j[m ? "show" : "hide"](!0).animate(v({
                x: d - h,
                y: e - h
        ...
        getAttribs: function () {
            var a = this, b = a.options,
                c = T[a.type].marker ? b.marker : b, d = c.states, e = d.hover, f, g = a.color;
            f = {stroke: g, fill: g};
        ...
        destroy: function () {
            ...
            q(a.axisTypes || [], function (b) {
                if (i = a[b])pa(i.series, a), i.isDirty = i.forceRedraw = !0
            });
        ...
        drawGraph: function () {
            ...
            q(c, function (c, h) {
                var j = c[0], l = a[j];
                if (l)eb(l), l.animate({d: g}); else if (d && g.length)l = {
                    stroke: c[1],
                    "stroke-width": d,
                    fill: Y,
                    zIndex: 1
        ...
        clipNeg: function () {
            ...
            if (d && (f || g)) {
                ...
                if (b.inverted)a.height = j.y = b.plotWidth - d, c.isVML && (a = {
                    x: b.plotWidth -
                    d - b.plotLeft, y: 0, width: e, height: k
        ...
        render: function () {
            var a = this, b = a.chart, c, d = a.options, e = (c = d.animation) && !!a.animate &&
                b.renderer.isSVG && o(c.duration, 500) || 0, f = a.visible ? "visible" : "hidden", g = d.zIndex, h = a.hasRendered, i = b.seriesGroup;
    ...
    Rb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative, g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0),
                c = M(g - c), h = d.xAxis[0].translate(this.x) + a, i = d.plotHeight, f = {
                    x: e ? f ? g : g - c : h,
    ...
    K.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options,
                f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, k = this.negStacks, j = this.yAxis, l = j.stacks, m = j.oldStacks, n, p, u, o, q, x;
            for (o = 0; o < d; o++) {
                q = a[o];
                x = b[o];
                u = this.index + "," + o;
    ...
    v(va.prototype, {
        addSeries: function (a, b, c) {
            ...
            if (!c)this.loadingDiv = c = $(Ta, {className: "highcharts-loading"}, v(d.style, {
                zIndex: 10,
                display: Y
            }), this.container), this.loadingSpan = $("span", null,
                d.labelStyle, c);
            ...
            }), ob(c, {opacity: d.style.opacity}, {duration: d.showDuration || 0}), this.loadingShown = !0
    ...
    v(K.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart, k = this.xAxis && this.xAxis.names, j = g && g.shift || 0, l = e.data,
                m, n = this.xData;
            Ya(d, i);
            ...
            var c = this.chart, d = this.type, e = C[d].prototype, f, a = y(this.userOptions, {
                    animation: !1,
                    index: this.index,
    ...
    var ta = ga(K, {
        type: "area", getSegments: function () {
            ...
            var a = this, b = this.areaPath, c = this.options,
                d = c.negativeColor, e = c.negativeFillColor, f = [["area", this.color, c.fillColor]];
    ...
    ta = ta.prototype;
    Aa = ga(Aa, {
        type: "areaspline", closedStacks: !0, getSegmentPath: ta.getSegmentPath, closeSegment: ta.closeSegment,
    ...
    Aa = ga(K, {
        type: "column", pointAttrToOptions: {
            ...
            var a = this, b = a.chart, c = a.options, d = a.borderWidth = o(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis, f = a.translatedThreshold =
                e.getThreshold(c.threshold), g = o(c.minPointLength, 5), c = a.getColumnMetrics(), h = c.width, i = a.barW = Va(w(h, 1 + 2 * d)), k = a.pointXOffset = c.offset, j = -(d % 2 ? 0.5 : 0), l = d % 2 ? 0.5 : 1;
            ...
            q(a.points, function (c) {
                ...
                c.barX = u;
                c.pointWidth = h;
                c.tooltipPos = b.inverted ? [e.len - p, a.xAxis.len - u - q / 2] : [u + q / 2,
                    p];
                d = M(u) < 0.5;
                q = s(u + q) + j;
                u = s(u) + j;
        ...
        }, getSymbol: na, drawLegendSymbol: Q.drawRectangle, drawGraph: na, drawPoints: function () {
            ...
            q(a.points, function (i) {
                ...
                if (k !== r && !isNaN(k) && i.y !== null)f = i.shapeArgs, h = t(a.borderWidth) ? {"stroke-width": a.borderWidth} : {}, g = i.pointAttr[i.selected ? "select" :
                    ""] || a.pointAttr[""], j ? (eb(j), j.attr(h)[b.pointCount < e ? "animate" : "attr"](y(f))) : i.graphic = d[i.shapeType](f).attr(g).attr(h).add(a.group).shadow(c.shadow, null, c.stacking && !c.borderRadius); else if (j)i.graphic = j.destroy()
            })
        }, animate: function (a) {
            var b = this.yAxis, c = this.options, d = this.chart.inverted, e = {};
            if (ca)a ? (e.scaleY = 0.001, a = z(b.pos + b.len, w(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e,
    ...
    J = {
        ...
        translate: function (a) {
            ...
            for (m = 0; m < n; m++) {
                ...
                p.shapeArgs = {
                    x: a[0], y: a[1],
                    r: a[2] / 2, innerR: a[3] / 2, start: s(f * 1E3) / 1E3, end: s(g * 1E3) / 1E3
                };
                h = (g + f) / 2;
    ...
    K.prototype.drawDataLabels = function () {
        ...
        if (d.enabled || a._hasPointLabels)a.dlProcessOptions && a.dlProcessOptions(d), i = a.plotGroup("dataLabelsGroup", "data-labels", "hidden", d.zIndex || 6), !a.hasRendered && o(d.defer, !0) && (i.attr({opacity: 0}), A(a, "afterAnimate", function () {
            ...
            if (l && !e)b.dataLabel = l.destroy(); else if (e) {
                ...
                if (l)if (t(h))l.attr({text: h}), u = !1; else {
    ...
    K.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, s(i), g) || d && f.isInsidePlot(h,
                g ? d.x + 1 : d.y + d.height - 1, g)))d = v({
            x: g ? f.plotWidth - i : h,
            y: s(g ? f.plotHeight - h : i),
            width: 0,
            height: 0
        }, d), v(c, {width: k.width, height: k.height}), c.rotation ? (g = {
            align: c.align,
            x: d.x + c.x + d.width / 2,
    ...
    if (C.pie)C.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding,
            10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, k, j = o(e.softConnector, !0), l = e.distance, m = a.center, n = m[2] / 2, p = m[1], u = l > 0, r, G, x, t, v = [[], []], y, z, A, B, D, U = [0, 0, 0, 0], I = function (a, b) {
            return b.y - a.y
        };
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            for (B = 2; B--;) {
                ...
                if (l >
                    ...
                    for (D = 0; D < E; D++) {
                        ...
                        if (F < D && b[D] !== null)F = D; else for (G < E - D + F && b[D] !== null && (F = G - E + D); b[F] === null;)F++;
                        H.push({i: F, y: b[F]});
                        b[F] = null
                    }
                    H.sort(I)
            ...
            if (Ba(U) === 0 || this.verifyDataLabelOverflow(U))this.placeDataLabels(), u && g && q(this.points, function (b) {
                i =
                    b.connector;
                x = b.labelPos;
                if ((r = b.dataLabel) && r._pos)A = r._attr.visibility, y = r.connX, z = r.connY, k = j ? ["M", y + (x[6] === "left" ? 5 : -5), z, "C", y, z, 2 * x[2] - x[4], 2 * x[3] - x[5], x[2], x[3], "L", x[4], x[5]] : ["M", y + (x[6] === "left" ? 5 : -5), z, "L", x[2], x[3], "L", x[4], x[5]], i ? (i.animate({d: k}), i.attr("visibility", A)) : b.connector = i = a.chart.renderer.path(k).attr({
                    "stroke-width": g,
    ...
    if (C.column)C.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        ...
        if (h && (d = y(h), g && (d = {
                ...
                width: d.height,
                height: d.width
            }), !k))g ? (d.x += i ? 0 : d.width, d.width = 0) : (d.y += i ? d.height : 0,
            d.height = 0);
    ...
    var gb = P.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length, f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor, l = j && {cursor: j}, j = a.singlePoints, m,
                n = function () {
    ...
    v(va.prototype, {
        showResetZoom: function () {
            ...
            q(b === "xy" ? [1, 0] : [1], function (b) {
                var d =
                    a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" : "mouseDownY"], k = (h.pointRange || 0) / 2, j = h.getExtremes(), l = h.toValue(i - d, !0) + k, i = h.toValue(i + c[b ? "plotWidth" : "plotHeight"] - d, !0) - k;
        ...
        select: function (a, b) {
            ...
            c.firePointEvent(a ? "select" :
                ...
                b || q(e.getSelectedPoints(), function (a) {
                    if (a.selected && a !== c)a.selected = a.options.selected = !1, d.options.data[wa(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
                })
            })
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states, g = T[e.type].marker && e.options.marker, h = g && !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic, l = this.marker || {}, m = e.chart, n = e.halo, p, a = a || "";
            ...
            if (!(a === this.state && !b || this.selected && a !== "select" || f[a] && f[a].enabled === !1 || a && (k || h && i.enabled === !1) || a && l.states && l.states[a] && l.states[a].enabled === !1)) {
                if (this.graphic)g = g && this.graphic.symbolName && p.r, this.graphic.attr(y(p, g ? {
                    x: c - g,
                    y: d - g,
                    width: 2 * g,
                    height: 2 * g
                } : {})), j && j.hide(); else {
                    if (a && i)if (g = i.radius, l = l.symbol || e.symbol, j && j.currentSymbol !==
                        l && (j = j.destroy()), j)j[b ? "animate" : "attr"]({
                        x: c - g,
                        y: d - g
    ...
    v(K.prototype, {
        onMouseOver: function () {
            ...
            var b = [], c, d, e = this.xAxis, f = e && e.getExtremes(), g = e ? e.tooltipLen ||
            e.len : this.chart.plotSizeX, h, i, k = [];
    ...
    v(L.prototype, {
        ...
        getExtendedPositions: function () {
            ...
            if (!c[d])f = {
                ...
                }, options: {ordinal: !0}, val2lin: L.prototype.val2lin
        ...
        "pan", function (a, b) {
            ...
            if (c.options.ordinal && c.series.length) {
                ...
                if (m.ordinalPositions) {
                    if (M(f) > 1)j && q(j, function (a) {
                        a.setState()
                    }), f < 0 ? (j = m, p = c.ordinalPositions ? c : m) : (j = c.ordinalPositions ? c : m, p = m), m = p.ordinalPositions, h > m[m.length - 1] && m.push(h),
    ...
    O(K.prototype, "getSegments", function (a) {
        ...
        a.apply(this, Array.prototype.slice.call(arguments, 1));
        if (c)b = this.segments, q(b, function (a,
                                                f) {
            for (var g = a.length - 1; g--;)a[g + 1].x - a[g].x > d.closestPointRange * c && b.splice(f + 1, 0, a.splice(g + 1, a.length - g))
        })
    });
    var ba = K.prototype, J = Hb.prototype, hc = ba.processData, ic = ba.generatePoints, jc = ba.destroy, kc = J.tooltipHeaderFormatter, lc = {
    ...
    }, Xb = [["millisecond", [1, 2, 5, 10, 20, 25, 50, 100, 200, 500]], ["second", [1, 2, 5, 10, 15, 30]], ["minute", [1, 2, 5, 10, 15, 30]], ["hour", [1, 2, 3, 4, 6, 8, 12]], ["day", [1]], ["week", [1]], ["month", [1, 3, 6]], ["year", null]], Na = {
        sum: function (a) {
            var b = a.length, c;
    ...
    ba.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [],
            h = [], i = a.length, k, j, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Na[d], n = this.pointArrayMap, p = n && n.length, o;
        ...
        for (; o <= i; o++) {
            ...
            if (n) {
                ...
                var q;
                for (j = 0; j < p; j++)if (q = k[n[j]], typeof q === "number")m[j].push(q); else if (q === null)m[j].hasNulls = !0
    ...
    ba.processData = function () {
        ...
        if (hc.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData, h = a.plotSizeX, a = this.xAxis, i = a.options.ordinal, k = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth(),
                d = this.pointRange;
            if (k) {
                e = !0;
                this.points = null;
    ...
    J.tooltipHeaderFormatter = function (a) {
        var b = a.series, c = b.tooltipOptions, d = b.options.dataGrouping,
            e = c.xDateFormat, f, g = b.xAxis, h;
    ...
    T.ohlc = y(T.column, {
        lineWidth: 1,
        tooltip: {pointFormat: '<span style="color:{series.color}">●</span> <b> {series.name}</b><br/>Open: {point.open}<br/>High: {point.high}<br/>Low: {point.low}<br/>Close: {point.close}<br/>'},
    ...
    J = ga(C.column, {
        ...
        drawPoints: function () {
            ...
            q(a.points, function (j) {
                if (j.plotY !== r)i = j.graphic, c = j.pointAttr[j.selected ? "selected" : ""] || a.pointAttr[""], f = c["stroke-width"] % 2 / 2, k = s(j.plotX) - f, g = s(j.shapeArgs.width / 2), h = ["M", k, s(j.yBottom), "L", k, s(j.plotY)], j.open !==
    ...
    J = ga(J, {
        ...
        drawPoints: function () {
            ...
            q(a.points, function (o) {
                m = o.graphic;
                if (o.plotY !== r)c = o.pointAttr[o.selected ? "selected" : ""] || d, j = c["stroke-width"] % 2 / 2, l = s(o.plotX) - j, e = o.plotOpen, f = o.plotClose, g = V.min(e,
    ...
    C.flags = ga(C.column, {
        ...
        translate: function () {
            ...
            var a = this.chart, b = this.points, c = b.length - 1, d, e, f = this.options.onSeries,
                f = (d = f && a.get(f)) && d.options.step, g = d && d.points, h = g && g.length, i = this.xAxis, k = i.getExtremes(), j, l, m;
            if (d && d.visible && h) {
        ...
        drawPoints: function () {
            ...
            for (k = c.length; k--;)if (j = c[k], a = j.plotX > this.xAxis.len, e = j.plotX + (a ? m : -m), l = j.stackIndex, i = j.options.shape || g.shape, f = j.plotY, f !== r && (f = j.plotY + h + m - (l !== r && l * g.stackDistance)), n = l ? r : j.plotX + m, o = l ? r : j.plotY, l = j.graphic, f !== r &&
                e >= 0 && !a)a = j.pointAttr[j.selected ? "select" : ""] || b, l ? l.attr({
                x: e,
                y: f,
                r: a.r,
                anchorX: n,
                ...
                width: g.width,
                height: g.height
            }).add(this.markerGroup).shadow(g.shadow), j.tooltipPos = [e, f]; else if (l)j.graphic = l.destroy()
        },
    ...
    yb.prototype = {
        drawHandle: function (a, b) {
            ...
            var e = this.chart, f = e.renderer, g, h,
                i, k, j = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis, n = this.scrollbarTrack, p = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions, t = this.scrollbarOptions, x = t.minWidth, v = this.height, y = this.top, A = this.navigatorEnabled, B = r.outlineWidth, C = B / 2, F = 0, D = this.outlineHeight, I = t.barBorderRadius, H = t.barBorderWidth, E = y + C, J;
            if (!isNaN(a)) {
                ...
                if (!(l.translate(d, !0) - l.translate(c, !0) < e.xAxis[0].minRange)) {
                    ...
                    if (!this.rendered) {
                        ...
                        if (q)this.scrollbarGroup = j = f.g("scrollbar").add(), m = t.trackBorderWidth, this.scrollbarTrack = n = f.rect().attr({
                            x: 0,
                            y: -m % 2 / 2,
                            ...
                            height: p
                        }).add(j), this.scrollbar = m = f.rect().attr({
                            y: -H %
                            2 / 2,
                            height: p,
                    ...
                    if (A) {
                        this.leftShade[e](r.maskInside ? {x: g + b, y: y, width: c - b, height: v} : {
                            x: g,
                            y: y,
                            width: b,
                            height: v
                    ...
                    if (q && j)this.drawScrollbarButton(0), this.drawScrollbarButton(1), j[e]({
                        translateX: i,
                        translateY: s(E + v)
                    }), n[e]({width: k}), g = p + b, h = a - H, h < x && (F = (x - h) / 2, h = x, g -= F), this.scrollbarPad = F, m[e]({
                        x: S(g) + H % 2 / 2,
                        width: h
                    }), x = p + b + a / 2 - 0.5, this.scrollbarRifles.attr({visibility: a > 12 ? "visible" : "hidden"})[e]({d: ["M", x - 3, p / 4, "L", x - 3, 2 * p / 3, "M", x, p / 4, "L", x, 2 * p / 3, "M", x + 3, p / 4, "L", x + 3, 2 * p / 3]});
                    this.scrollbarPad = F;
                    this.rendered = !0
                }
            }
            ...
            var a = this, b = a.chart, c, d, e = a.scrollbarHeight,
                f = a.navigatorOptions, g = a.height, h = a.top, i, k, j = document.body.style, l, m = a.baseSeries;
            a.mouseDownHandler = function (d) {
                ...
                if (t > h && t < h + g + k)if ((h = !a.scrollbarEnabled || t < h + g) && V.abs(s - e - o) < w)a.grabbedLeft = !0, a.otherHandlePos = f, a.fixedExtreme = d.max, b.fixedRange = null; else if (h && V.abs(s -
                    f - o) < w)a.grabbedRight = !0, a.otherHandlePos = e, a.fixedExtreme = d.min, b.fixedRange = null; else if (s > o + e - q && s < o + f + q) {
                    a.grabbedCenter = s;
                    a.fixedWidth = r;
                    ...
                    if (f < 0)f = 0; else if (f + r >= p)f = p - r, v = c.dataMax;
            ...
            a.mouseMoveHandler = function (c) {
                var d = a.scrollbarHeight, e = a.navigatorLeft,
                    f = a.navigatorWidth, g = a.scrollerLeft, h = a.scrollerWidth, j = a.range, l;
            ...
            a.navigatorEnabled ? (a.xAxis = c = new L(b, y({ordinal: m && m.xAxis.options.ordinal},
                ...
                index: p,
                zoomEnabled: !1
            })), m || f.series.data ? a.addBaseSeries() : b.series.length === 0 && O(b, "redraw", function (c, d) {
            ...
            var b =
                this.chart.xAxis[0], c = this.xAxis, d = c.options;
            ...
            var a = this.baseSeries, b = a ? a.options :
            {}, c = b.data, d = this.navigatorOptions.series, e;
            e = d.data;
            ...
            var a =
                this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max, g = d.dataMin, d = d.dataMax, h = f - e, i, k, j, l, m, n = a.series;
            i = n.xData;
            var o = !!c.setExtremes;
    ...
    zb.prototype = {
        clickButton: function (a, b) {
            ...
            if (!(k === null || j === null || a === c.selected)) {
                if (p === "month" || p === "year")l = {
                    month: "Month",
                    year: "FullYear"
                }[p], n["set" + l](n["get" + l]() - u), l = n.getTime(), k = o(k, Number.MIN_VALUE), isNaN(l) || l <
                k ? (l = k, m = z(l + i, j)) : i = m - l; else if (i)l = w(m - i, k), m = z(l + i, j); else if (p === "ytd")if (h) {
                    if (j === r)k = Number.MAX_VALUE, j = Number.MIN_VALUE, q(e.series, function (a) {
                        a = a.xData;
                        k = z(a[0], k);
                        j = w(a[a.length - 1], j)
                    }), b = !1;
        ...
        drawInput: function (a) {
            ...
            this[a + "DateBox"] = j = e.label("", l.offset).attr({
                ...
                "stroke-width": 1
            }).css(y({textAlign: "center", color: "#444"}, d, f.inputStyle)).on("click", function () {
                b[a + "Input"].focus()
            }).add(l);
            ...
            i.onchange = function () {
                var a = i.value, d = (f.inputDateParser || Date.parse)(a), e = c.xAxis[0], g = e.dataMin, j =
                    e.dataMax;
        ...
        render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options, h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons, g = F.lang, j = c.div, j = c.inputGroup,
                l = i.buttonTheme, m = i.inputEnabled !== !1, n = l && l.states, p = d.plotLeft, r;
    ...
    P.StockChart = function (a, b) {
        var c = a.series, d, e = o(a.navigator && a.navigator.enabled, !0) ? {
            startOnTick: !1,
            endOnTick: !1
    ...
    L.prototype.getPlotLinePath = function (a, b, c, d, e) {
        ...
        v = f.isXAxis ? t(f.options.yAxis) ? [h.yAxis[f.options.yAxis]] : xa(g, function (a) {
            return a.yAxis
        }) : t(f.options.xAxis) ? [h.xAxis[f.options.xAxis]] : xa(g, function (a) {
            return a.xAxis
        });
        q(f.isXAxis ? h.yAxis : h.xAxis, function (a) {
            if (t(a.options.id) ? a.options.id.indexOf("navigator") === -1 : 1) {
                var b = a.isXAxis ? "yAxis" : "xAxis", b = t(a.options[b]) ?
    ...
    O(L.prototype, "hideCrosshair", function (a, b) {
        ...
        this.crossLabelArray[b].hide() : q(this.crossLabelArray, function (a) {
            a.hide()
        }))
    });
    O(L.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            ...
            if (m < k || m > k + this.height)this.hideCrosshair(); else {
                !n && !f.formatter && (this.isDatetimeAxis && (p = "%b %d, %Y"), n = "{value" + (p ? ":" + p : "") + "}");
                j.attr({
                    text: n ?
                        Ja(n, {value: c[g]}) : f.formatter.call(this, c[g]), x: l, y: m, visibility: "visible"
                });
                c = j.getBBox();
                if (b) {
    ...
    var mc = ba.init, nc = ba.processData,
    ...
    ba.processData = function () {
        ...
        if (this.xAxis && this.processedYData) {
            ...
            for (d = c.length; a <
            d; a++)if (typeof c[a] === "number" && b[a] >= this.xAxis.min) {
